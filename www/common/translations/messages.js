...
define(function () {
    ...
    out.fm_selectError = "Unable to select the targeted element. If the problem persist, try to reload the page.";
    ...
    out.faq.usability = {
        ...
        change: {
            ...
            a: "You can change your CryptPad password in settings."
        },
        devices: {
