...
// CryptPad_AsyncStore.rpc.send('ADMIN', ['CLEAR_CHANNEL_INDEX', documentID], console.log)
...
// CryptPad_AsyncStore.rpc.send('ADMIN', ['GET_CHANNEL_INDEX', documentID], console.log)
...
var commands = {
    ...
    CLEAR_CHANNEL_INDEX: clearChannelIndex,
    GET_CHANNEL_INDEX: getChannelIndex,
