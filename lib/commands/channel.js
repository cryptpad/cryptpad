...
Channel.clearOwnedChannel = function (Env, safeKey, channelId, cb, Server) { // XXX backup
...
var archiveOwnedChannel = function (Env, safeKey, channelId, _cb, Server) { // XXX backup
    var unsafeKey = Util.unescapeKeyCharacters(safeKey);
    nThen(function (w) {
...
Channel.removeOwnedChannel = function (Env, safeKey, channelId, __cb, Server) { // XXX backup
...
Channel.trimHistory = function (Env, safeKey, data, cb) { // XXX backup
...
*/
Channel.writePrivateMessage = function (Env, args, _cb, Server, netfluxId) { // XXX backup
