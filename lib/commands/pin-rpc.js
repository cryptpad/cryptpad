...
Pinning.removePins = function (Env, safeKey, cb) {
    ...
    Env.pinStore.removeChannel(safeKey, function (err) { // XXX backup
...
Pinning.trimPins = function (Env, safeKey, cb) { // XXX backup
    cb("NOT_IMPLEMENTED");
};
    ...
    getChannelList(Env, safeKey, function (pinned) {
        ...
        getMultipleFileSize(Env, toStore, function (e, sizes) {
            ...
            getFreeSpace(Env, safeKey, function (e, free) {
                ...
                Env.pinStore.message(safeKey, JSON.stringify(['PIN', toStore, +new Date()]), // XXX backup
                    function (e) {
                    if (e) { return void cb(e); }
...
Pinning.unpinChannel = function (Env, safeKey, channels, cb) { // XXX backup
    if (!channels && channels.filter) {
        // expected array
        return void cb('INVALID_PIN_LIST');
    }
    ...
    getChannelList(Env, safeKey, function (pinned) {
        ...
        Env.pinStore.message(safeKey, JSON.stringify(['UNPIN', toStore, +new Date()]), // XXX backup
            function (e) {
            if (e) { return void cb(e); }
            toStore.forEach(function (channel) {
...
Pinning.resetUserPins = function (Env, safeKey, channelList, cb) {
    ...
    getMultipleFileSize(Env, channelList, function (e, sizes) {
        ...
        getLimit(Env, safeKey, function (e, limit) {
            ...
            Env.pinStore.message(safeKey, JSON.stringify(['RESET', channelList, +new Date()]), // XXX backup
                function (e) {
                if (e) { return void cb(e); }
