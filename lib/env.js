...
module.exports.create = function (config) {
    ...
    const Env = {
        ...
        darkThemeBgBody: config.darkThemeBgBody,
        darkThemeBgAlert: config.darkThemeBgAlert,
        darkThemeColorBrand: config.darkThemeColorBrand,
        darkThemeTextColor: config.darkThemeTextColor,
        showBgImage: config.showBgImage,
        bgImage:config.bgImage,
        darkBgImage:config.darkBgImage,
        navButtonBgColor:config.navButtonBgColor,
        darkNavButtonBgColor:config.darkNavButtonBgColor,
        lookDir:config.lookDir,
