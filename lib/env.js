...
*/
    ...
    (function() {
        var configVariableArray = ["bgBody", "darkBgBody", "bgAlert", "darkBgAlert",
         "brandColor", "darkBrandColor", "textColor", "darkTextColor", "navBgColor",
         "darkNavBgColor", ];

        for ( var i = 0; i < configVariableArray.length; i++) {
            var currentVarName = configVariableArray[i];
            Env[currentVarName] = config[currentVarName];
        }
        console.log("env.js - Env.darkBrandColor :", Env.darkBrandColor);
    }());
