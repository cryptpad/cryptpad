...
See [Cryptpad-Docker](https://github.com/xwiki-labs/cryptpad-docker) page for details on how to get up-and-running with Cryptpad in Docker. This repository is maintained by the community and not officially supported.
